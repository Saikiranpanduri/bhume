...
# ============================================================================
# BHUME IMPORT - Direct import from modules
# ============================================================================

try:
    # Try standard import first
    from bhume import load, write_predictions, score
    print("✅ bhume imported from package\n")
except ImportError:
    # If that fails, import directly from modules
    try:
        from bhume.io import load, write_predictions
        from bhume.score import score
        print("✅ bhume functions imported directly from modules\n")
    except ImportError as e:
        print(f"❌ ERROR: Could not import bhume functions")
        print(f"   {e}")
        print(f"\nMake sure you're running from the correct directory:")
        print(f"   C:\\Users\\pandu\\Downloads\\bhume\\bhume-starter-kit\\")
        sys.exit(1)
